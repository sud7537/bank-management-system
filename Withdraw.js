...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="formGroupExampleInput" onInput={(e)=>setac(e.target.value)} placeholder=""/>
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Enter Pin Number</label>
  <input type="text" class="form-control" id="formGroupExampleInput2" onInput={(e)=>setpin(e.target.value)} placeholder=""/>
</div>
<div class="mb-3">
  <label for="formGroupExampleInput" class="form-label">Enter Amount to Withdraw</label>
  <input type="text" class="form-control" id="formGroupExampleInput" onInput={(e)=>setamount(e.target.value)} placeholder=""/>
</div>
<div class="col-12">
    <button type="submit" class="btn btn-success" onClick={()=>withdrwaAmount()}>Withdraw</button>
  </div>
        </div>
        </div>
        </div>
